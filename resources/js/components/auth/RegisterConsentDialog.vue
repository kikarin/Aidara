        ...
        <DialogContent class="max-w-[400px] gap-0 overflow-hidden rounded-2xl p-0">
            <div class="border-b border-border bg-gradient-to-br from-primary/10 via-background to-background px-6 pt-6 pb-4">
                <div class="flex items-center gap-3">
                    ...
                    <DialogHeader class="space-y-1 text-left">
                        <DialogTitle class="text-base">Persetujuan Pendaftaran</DialogTitle>
                        <DialogDescription class="text-xs">
                            Baca dan setujui kebijakan sebelum mendaftar di Aidara.
                        </DialogDescription>
                    </DialogHeader>
                </div>
            </div>
            ...
            <div class="max-h-[50vh] space-y-4 overflow-y-auto px-6 py-4">
                <div class="space-y-3 text-sm leading-relaxed text-muted-foreground">
                    <p>
                        Aidara akan menyimpan data pribadi Anda (identitas, data olahraga, pemeriksaan, dan dokumen)
                        untuk keperluan pendaftaran dan manajemen keolahragaan Dispora Kabupaten Bogor.
                    </p>
                    <p>
                        Dengan mendaftar, Anda menyetujui pemrosesan data sesuai
                ...
                <ul class="space-y-2 text-sm">
                    <li>
                        <Link :href="route('legal.show', { slug: 'terms' })" target="_blank" class="font-medium text-primary hover:underline">
                            Syarat & Ketentuan
                        </Link>
                        <span class="text-muted-foreground"> — aturan penggunaan layanan Aidara</span>
                    </li>
                    <li>
                        <Link :href="route('legal.show', { slug: 'privacy' })" target="_blank" class="font-medium text-primary hover:underline">
                            Kebijakan Privasi
                        </Link>
                        <span class="text-muted-foreground"> — cara data pribadi dikumpulkan dan digunakan</span>
                    </li>
                    <li>
                        <Link :href="route('legal.show', { slug: 'pdp' })" target="_blank" class="font-medium text-primary hover:underline">
                ...
                <label class="flex cursor-pointer items-start gap-3 rounded-xl border border-border bg-muted/40 p-3">
                    <Checkbox id="register-consent" v-model="agreed" class="mt-0.5" />
