...
const activeItemStyles = computed(
    () => (url: string) => (isCurrentRoute.value(url) ? 'bg-accent text-accent-foreground' : ''),
);
...
<template>
    <div>
        ...
        <div v-if="props.breadcrumbs.length > 1" class="border-sidebar-border/70 flex w-full border-b">
            <div class="text-muted-foreground mx-auto flex h-12 w-full items-center justify-start px-4 md:max-w-7xl">
