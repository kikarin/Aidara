        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col flex-wrap items-center justify-center gap-4 text-center sm:flex-row sm:justify-between">
                ...
                <div class="w-full sm:w-64">
                    <Input :model-value="searchQuery" @update:model-value="(val: any) => handleSearch(val as string)" placeholder="Cari..." class="w-full" />
                </div>
            </div>
            ...
            <div v-else class="rounded-md shadow-sm">
                ...
                <div class="text-muted-foreground flex flex-col items-center justify-center gap-2 border-t p-4 text-center text-sm md:flex-row md:justify-between">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-2">
                        <Button size="sm" :disabled="currentPage === 1" @click="handlePageChange(currentPage - 1)" class="bg-muted/40 text-foreground"> Sebelumnya </Button>
                        <div class="flex flex-wrap items-center gap-1">
                            <Button
                                ...
                                :class="[currentPage === page ? 'bg-primary text-primary-foreground border-primary' : 'bg-muted border-input text-foreground']"
                                @click="handlePageChange(page)"
                            >
                                {{ page }}
                            </Button>
                        </div>
                        <Button size="sm" :disabled="currentPage === totalPages" @click="handlePageChange(currentPage + 1)" class="bg-muted/40 text-foreground"> Selanjutnya </Button>
                    </div>
                </div>
            </div>
