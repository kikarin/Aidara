...
const formInitialData = computed(() => ({
    ...
    jenis_periode: props.initialData?.jenis_periode || '',
...
const formInputs = computed(() => [
    ...
    {
        name: 'file',
        label: 'File Program (Foto, PDF, Excel, dll)',
        type: 'file' as const,
        placeholder: 'Pilih file (maks 10MB)',
        required: false,
        help: 'Format yang didukung: JPEG, PNG, GIF, PDF, XLS, XLSX, DOC, DOCX',
    },
    {
        name: 'keterangan',
        label: 'Keterangan',
