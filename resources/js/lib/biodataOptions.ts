...
export const UKURAN_BAJU_OPTIONS: BiodataOption[] = toOptions(['XS', 'S', 'M', 'L', 'XL', 'XXL', 'XXXL']);
...
export function mapApiListToOptions(items: Array<{ id: number; nama: string }>): BiodataOption[] {
