...
class UpdatePemeriksaanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'tenaga_pendukung_id' => 'sometimes|required|exists:tenaga_pendukungs,id',
            'nama_pemeriksaan' => 'sometimes|required|string|max:200',
            'tanggal_pemeriksaan' => 'sometimes|required|date',
