...
class MstParameterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'kategori'      => 'required|in:kesehatan,umum',
        ...
        // Validasi khusus untuk parameter umum
    ...
    public function messages(): array
    {
        return [
            ...
            'kategori.in'            => 'Kategori harus kesehatan atau umum.',
            'nilai_target.required'  => 'Nilai target wajib diisi untuk parameter umum.',
            'nilai_target.max'       => 'Nilai target tidak boleh lebih dari 100 karakter.',
            'performa_arah.required' => 'Arah performa wajib diisi untuk parameter umum.',
